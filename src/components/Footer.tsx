...
function Footer() {
    ...
    <div className='footer mt-[10%] h-[260px] w-[85%] rounded-md flex justify-evenly items-center flex-col bg-[#0070F4] l'>
        <div className='footerhead h-1/2 flex justify-center text-4xl font-semibold text-white items-center'>are you read </div>
        ...
        <div className='link h-[100%] w-[100%] flex items-center justify-center  lg:w-[30%]'>
            <Link to="/resources" className='gs_link h-1/2 rounded-md flex items-center justify-center w-[min(300px,80%)] bg-white lg:h-1/3'>Soem Improvements here and there </Link>
        </div>
        </div>
    </div> );
}
