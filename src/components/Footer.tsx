...
function Footer() {
    ...
    <div className='footer mt-[10%] h-[260px] w-[85%] rounded-md flex justify-evenly items-center flex-col bg-[#0070F4] l'>
        ...
        <div className='footer_desc h-full w-7/10 flex justify-center items-center'>We have a generous free tier available to get you started right away.</div>
        <div className='link h-[100%] w-[100%] flex items-center justify-center  lg:w-[30%]'>
            <a href="#" className='gs_link h-1/2 rounded-md flex items-center justify-center w-[min(300px,80%)] bg-white lg:h-1/3'>Get started for free</a>
        </div>
        </div>
    </div> );
}
